...
<?php 
$resultados = mysqli_query($conexion,"SELECT idCliente,nombreCliente,idMeses,numeroMeses,nombreMeses,tipoOperacion,MAX(mesesPagados) as mesesPagados from lotes 
                                                        INNER JOIN clientes ON lotes.clienteLote = clientes.idCliente
                                                        INNER JOIN meses ON meses.idMeses = lotes.plazoLote 
                                                        INNER JOIN operacion ON operacion.idOperacion = lotes.operacionLote
                                                        INNER JOIN pagos on lotes.loteLote = pagos.lotePago
                                                        WHERE loteLote='$loteLote'");
  while($consulta = mysqli_fetch_array($resultados))
  {
    $clientePago = $consulta['idCliente'];
    $nombreClientePago = $consulta['nombreCliente'];
    $lotePago = $loteLote;
    $plazoLoteNombre = $consulta['nombreMeses'];
    $plazoPago = $consulta['idMeses'];
    $mesesPagados =$consulta['mesesPagados']+1;
  }
?>
<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <label>Plazo</label>
                                                <input type="text" class="form-control"
                                                    value="<?php echo $plazoLoteNombre ;?>" name="plazoLoteNombre" id="plazoLoteNombre"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select id="operacionPago" name="operacionPago" class="custom-select">
                                                    ...
                                                    <option id="loteLote4" name="loteLote4" value="0">4.- Contado
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="" value="<?php echo $mesesPagados ;?>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="1000"
                                                        value="1000" name="cantidadPago" id="cantidadPago"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <input type="submit" value="Registrar" class="btn btn-success"
                                                ...
                                                <?php
                       echo $clientePago ;
    echo $nombreClientePago;
    echo $lotePago;
    echo $plazoLoteNombre;
    echo $plazoPago;
    echo $mesesPagados;
    ?>
                                        </div>
    ...
    $mesesPagados = $_POST['mesesPagados'];
    if(isset($_POST['btn_registrar']))
    {
            $ejecutar= mysqli_query($conexion, "INSERT INTO $tabla_pagos (clientePago,lotePago,operacionPago,plazoPago,fechaPago,cantidadPago,mesesPagados) 
                                VALUES ('$clientePago','$lotePago','$operacionPago','$plazoPago','$fechaPago','$cantidadPago','$mesesPagados')");
                                if(!$ejecutar){
                                    echo '
