...
$resultados = mysqli_query($conexion,"SELECT * FROM clientes
                                      INNER JOIN lotes ON clientes.idCliente = lotes.clienteLote
                                      INNER Join pagos ON pagos.clientePago = clientes.idCliente
                                      INNER JOIN operacion ON operacion.idOperacion = pagos.operacionPago
                                      INNER JOIN meses ON meses.idMeses = pagos.plazoPago");
  while($row = mysqli_fetch_array($resultados)){
      ?>
    <tr>
    <td><?php echo $row['lotePago']; ?></td> 
<td><?php echo $row['nombreCliente']; ?></td> 
<td><?php echo $row['tipoOperacion']; ?></td> 
<td><?php echo $row['nombreMeses']; ?></td> <!--plazo-->
<td><?php echo $row['mesesPagados']; ?></td>
<td><?php echo $row['fechaPago']; ?></td>
<td><?php echo $row['cantidadPago']; ?></td>
<td><a text-align="center" href="editar-pago.php?idPago=<?php echo $row['idPago']; ?>" class="btn btn-accent btn-icon" type="button"><i class="fa fa-edit"></i></a>
</td>
</tr>
<?php  } ?>
